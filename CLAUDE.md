...
- **3 · Medical Ninjutsu** — hồi chiêu `gs(18)`, kết ấn `gs(1)` đứng yên, **vẫn ăn đòn và vẫn bị khống chế**;
  bị cắt ngang ⇒ chỉ chờ `gs(4)`. Xong cast thì **5 nhịp** cách nhau `gs(.5)` hồi **3.5% MÁU
  TỐI ĐA** mỗi nhịp (tổng **17.5%**).
  ...
  - **Hồi theo MÁU TỐI ĐA, KHÔNG theo máu đang thiếu** — người dùng chốt: *"thay đổi cơ chế
    ...
    **203**). Lối mới phẳng: 3.5% × 5 = **17.5% máu tối đa = 140 máu** trên thanh 800, bao
    nhiêu máu cũng bấy nhiêu. *(Đường đi của con số: 6.2% máu đang thiếu → 5.8% máu đang
    thiếu → 3% máu tối đa → **3.5% máu tối đa**, người dùng nới lại một nấc sau khi xem.)*
  - **Lượng hồi CHỤP LẠI đúng lúc cast xong**, không tính lại sau mỗi nhịp.
  - Có đồng đội thì hệ số chia đôi: **1.75% cho cô, 1.75% cho đồng đội máu thấp nhất**, mỗi
